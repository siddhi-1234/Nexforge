    ...
    >
      ...
      >
        <div className="progress-ring-inner">
          ...
          {sublabel && (
            <span className="progress-ring-sublabel">{sublabel}</span>
          )}
        </div>
      </div>
    </div>
...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    const handleNewNotification = (notification) => {
      console.log(
        "Socket new-notification event received in StudentDashboard:",
        notification,
      );
    ...
    const handleUnreadCount = (count) => {
      console.log(
        "Socket notification-unread-count event received in StudentDashboard:",
        count,
      );
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dash-layout">
        {isSidebarOpen && (
          <div className="dash-sidebar-overlay" onClick={toggleSidebar} />
        )}
        ...
        >
          <div className="dash-sidebar-header">
            ...
            <button className="dash-sidebar-close" onClick={toggleSidebar}>
              ✕
            </button>
          </div>
        ...
        <main className="dash-main">
          <header className="dash-topbar glassmorphism">
            <div className="dash-topbar-left">
              <button className="dash-menu-btn" onClick={toggleSidebar}>
                ☰
              </button>
          ...
          <div className="dash-content">
            ...
            <section ref={setRef("hero")} className={sectionClass("hero")}>
              <div className="dash-card dash-hero glassmorphism staggered-item shine-card float-card">
                  ...
                  {[
                    {
                      ...
                      value: 847,
                      colorClass: "dash-stat-teal",
                      barWidth: "70%",
                    },
                    {
                      label: "Active Projects",
                      value: 3,
                      colorClass: "dash-stat-coral",
                    },
                    {
                      label: "Tasks Pending",
                      value: 12,
                      colorClass: "dash-stat-error",
                      hasPulse: true,
                    },
                    {
                      label: "Skill Growth",
                    ...
                    <div
                      key={stat.label}
                      className="dash-stat-box glass-inner staggered-item hover-lift glow-hover"
                    ...
                    >
                      ...
                      {stat.barWidth && (
                        <div className="dash-stat-bar">
                          <div
                            className="dash-stat-bar-fill progress-draw"
                            style={{ width: stat.barWidth }}
                          />
                        </div>
                      )}
                      {stat.hasPulse && (
                        <span className="dash-pulse-dot pulse-animation" />
                      )}
                      {stat.isGrowth && (
                ...
                <div
                  className="dash-readiness-mini staggered-item"
            ...
            <section
              ref={setRef("projects")}
              className={sectionClass("projects")}
            >
              <div className="dash-section-header">
                <h2 className="staggered-item">🚀 Current Projects</h2>
                <button className="dash-link-btn hover-glow staggered-item">
                  View All Archives
                </button>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Full-stack Marketplace Deployment",
                    progress: 65,
                    avatars: ["JK", "RS", "+2"],
                    color: "teal",
                    time: "4 Days left",
                  ...
                  },
                  {
                    ...
                    desc: "AI-driven Productivity Engine",
                    progress: 12,
                    avatars: ["ML", "+1"],
                    color: "coral",
                    time: "12 Days left",
                  ...
                  <TiltCard
                    key={proj.title}
                    className="dash-project-card glassmorphism staggered-item"
                  ...
                  >
                    <div className="dash-project-top">
                      ...
                      <div className="dash-avatar-stack">
                        {proj.avatars.map((av, j) => (
                          <div
                            key={j}
                            className={`dash-mini-avatar ${av.startsWith("+") ? "dash-mini-avatar-more" : ""}`}
                          >
                            {av}
                          </div>
                        ))}
                    ...
                    <div className="dash-sprint-box glass-inner">
                      <div className="dash-sprint-top">
                        ...
                        <span
                          className={`dash-sprint-pct dash-stat-${proj.color}`}
                        >
                          {proj.progress}% DONE
                        </span>
                      </div>
                      <div className="dash-stat-bar">
                        <div
                          className={`dash-stat-bar-fill ${proj.color === "teal" ? "dash-gradient-fill" : "dash-gradient-fill-rev"} progress-draw`}
                    ...
                    <div className="dash-project-footer">
                      <span>⏱ {proj.time}</span>
                      <span
                        className={`dash-pill dash-pill-${proj.color} glow-pill`}
                      >
                        {proj.status}
                      </span>
                    </div>
            ...
            >
              <div className="staggered-item">
                ...
                <div className="dash-card dash-activity-list glassmorphism">
                  {[
                    {
                      icon: "⚡",
                      title: "feat: implemented auth provider",
                      meta: "COMMIT #f29a01 • 2m ago",
                    },
                    {
                      icon: "🔧",
                      title: "fix: resolved hydration error in layout",
                      meta: "COMMIT #a102bc • 45m ago",
                    },
                    {
                      icon: "📦",
                      title: "build: updated dependencies",
                      meta: "COMMIT #d83e21 • 3h ago",
                    },
                  ].map((act, i) => (
                    <div
                      key={i}
                      className="dash-activity-item hover-lift"
                      style={{ animationDelay: `${i * 0.05}s` }}
                    >
                      <div className="dash-activity-icon floating-icon">
                        {act.icon}
                      </div>
              ...
              >
                <h2 className="dash-col-heading dash-col-heading-error">
                  🔥 Live Changes
                </h2>
                  ...
                  <div className="dash-live-item hover-lift">
                    ...
                    <div className="dash-live-text">
                      <div className="dash-live-row">
                        <p>
                          John Doe{" "}
                          <span className="neon-text-coral">editing</span>
                        </p>
                        <span className="dash-live-badge dash-live-badge-error">
                          LIVE
                        </span>
                      </div>
                      <p className="dash-live-file">
                  ...
                  <div className="dash-live-item hover-lift">
                    ...
                    <div className="dash-live-text">
                      <div className="dash-live-row">
                        <p>
                          Alice Smith{" "}
                          <span className="neon-text-teal">reviewing</span>
                        </p>
                        <span className="dash-live-badge dash-live-badge-teal">
                          ONLINE
                        </span>
                      </div>
            ...
            <section
              ref={setRef("matches")}
              className={sectionClass("matches")}
            >
              <div className="dash-section-header">
              ...
              <div className="dash-match-grid">
                {[
                  {
                    ...
                    company: "Stripe • Remote • Full-time",
                  ...
                  },
                  {
                    ...
                    company: "Figma • London • Hybrid",
                    tags: ["Figma", "Design Systems"],
                  },
                ].map((match, i) => (
                  <TiltCard
                    key={match.title}
                    className="dash-match-card glassmorphism staggered-item"
                    style={{ animationDelay: `${i * 0.1}s` }}
                  >
                    <span className="dash-match-pct neon-text-teal">
                      {match.pct} MATCH
                    </span>
                    <div className="dash-match-avatar floating-icon">
                      {match.icon}
                    </div>
                    ...
                    <div className="dash-tag-row">
                      {match.tags.map((tag) => (
                        <span key={tag} className="dash-tag glass-tag">
                          {tag}
                        </span>
                      ))}
                    </div>
                    <button className="dash-btn-primary neon-btn-teal">
                      Apply with AI
                    </button>
                  </TiltCard>
                ))}
                ...
                <div
                  className="dash-card dash-match-empty glassmorphism staggered-item"
                  style={{ animationDelay: "0.2s" }}
                >
                  <div className="dash-match-empty-icon floating-icon">➕</div>
                  <p>
                    More matches loading based on your recent skill growth...
                  </p>
                </div>
              </div>
            </section>
            ...
            <section ref={setRef("skills")} className={sectionClass("skills")}>
              ...
              <div className="dash-skills-grid">
                {[
                  ...
                  <TiltCard
                    key={skill.title}
                    className="dash-skill-card glassmorphism staggered-item"
                    style={{ animationDelay: `${i * 0.05}s` }}
                  >
                    <div className="dash-skill-top">
                      <div
                        className={`dash-skill-icon dash-skill-icon-${skill.color} floating-icon`}
                      >
                        {skill.icon}
                      </div>
                      <span
                        className={`dash-badge dash-badge-${skill.badge === "VERIFIED" ? "verified" : "level"} neon-text-${skill.color === "blue" ? "teal" : "coral"}`}
                      >
                        {skill.badge}
                      </span>
                    </div>
            ...
            {/* ── READINESS DETAIL ── */}
            <section
              ref={setRef("readiness")}
              className={sectionClass("readiness")}
            >
              <div className="dash-card dash-readiness-detail glassmorphism staggered-item">
                ...
                <div className="dash-readiness-breakdown">
                  <h2 className="neon-text-teal">
                    Internship Readiness Analysis
                  </h2>
                  {[
                    ...
                    <div
                      key={item.label}
                      className="dash-breakdown-item staggered-item"
                      style={{ animationDelay: `${i * 0.05}s` }}
                    >
                  ...
                  <button
                    className="dash-btn-report neon-btn-coral staggered-item"
                    style={{ animationDelay: "0.2s" }}
                  >
      ...
      <button
        className="dash-fab layout-fab-spring"
